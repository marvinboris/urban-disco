"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Posts_index_js"],{
...
/***/ "./resources/js/src/containers/Backend/User/Posts/index.js":
/*!*****************************************************************!*\
  !*** ./resources/js/src/containers/Backend/User/Posts/index.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _store_actions_backend_posts__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../store/actions/backend/posts */ "./resources/js/src/store/actions/backend/posts.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          _this$props$content$c3 = _this$props$content$c.backend.pages.posts,
      ...
      var data = posts.map(function (post) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(post, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.convertDate)(post.created_at),
          post_category: post.post_category[lang],
          title: post.title[lang],
          body: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.htmlEntities)(post.body[lang]),
          photo: post.photo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
            className: "d-flex",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)("span", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_components_Backend_UI_View_View__WEBPACK_IMPORTED_MODULE_11__["default"], {
                title: "".concat(form.post_photo, ": ").concat(post.title[lang]),
          ...
          action: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(react_router_dom__WEBPACK_IMPORTED_MODULE_17__.Link, {
              ...
              to: "/user/posts/".concat(post.id, "/edit"),
              className: "mx-1",
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_components_Backend_UI_Delete_Delete__WEBPACK_IMPORTED_MODULE_9__["default"], {
                deleteAction: function deleteAction() {
                  return _this.props["delete"](post.id);
                },
                children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_fortawesome_react_fontawesome__WEBPACK_IMPORTED_MODULE_2__.FontAwesomeIcon, {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_posts__WEBPACK_IMPORTED_MODULE_12__.getPosts)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_posts__WEBPACK_IMPORTED_MODULE_12__.deletePosts)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_posts__WEBPACK_IMPORTED_MODULE_12__.resetPosts)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/posts.js":
/*!*********************************************************!*\
  !*** ./resources/js/src/store/actions/backend/posts.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "getPostsInfo": () => (/* binding */ getPostsInfo),
/* harmony export */   "getPost": () => (/* binding */ getPost),
/* harmony export */   "postPosts": () => (/* binding */ postPosts),
/* harmony export */   "patchPosts": () => (/* binding */ patchPosts),
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_1__.manageResource.apply(void 0, ['posts', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.POSTS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.POSTS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.POSTS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetPosts = function resetPosts() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.POSTS_RESET
  };
};
...
var getPostsInfo = function getPostsInfo() {
  return resource('info');
};
var getPost = function getPost(id) {
  return resource('show', id);
};
var postPosts = function postPosts(data) {
  return resource('post', data);
};
var patchPosts = function patchPosts(id, data) {
  return resource('patch', id, data);
};
var deletePosts = function deletePosts(id) {
