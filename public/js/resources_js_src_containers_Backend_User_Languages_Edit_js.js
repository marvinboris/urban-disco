...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_1__.manageResource.apply(void 0, ['languages', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.LANGUAGES_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.LANGUAGES_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.LANGUAGES_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetLanguages = function resetLanguages() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.LANGUAGES_RESET
  };
};
