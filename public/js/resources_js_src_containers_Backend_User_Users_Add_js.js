...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_1__.manageResource.apply(void 0, ['users', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.USERS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.USERS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.USERS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetUsers = function resetUsers() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.USERS_RESET
  };
};
