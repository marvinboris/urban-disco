"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_src_containers_Backend_User_Products_index_js"],{
...
/* harmony import */ var _store_actions_backend_products__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../../../store/actions/backend/products */ "./resources/js/src/store/actions/backend/products.js");
  ...
  _createClass(Index, [{
    ...
    value: function render() {
      ...
      var data = products.map(function (product) {
        return (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.updateObject)(product, {
          created_at: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.convertDate)(product.created_at),
          name: product.name[lang],
          description: (0,_shared_utility__WEBPACK_IMPORTED_MODULE_13__.htmlEntities)(product.description[lang]),
          photo: product.photo && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
            className: "d-flex",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)("span", {
              ...
              children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)(_components_Backend_UI_View_View__WEBPACK_IMPORTED_MODULE_11__["default"], {
                title: "".concat(form.post_photo, ": ").concat(product.name[lang]),
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    get: function get(page, show, search) {
      return dispatch((0,_store_actions_backend_products__WEBPACK_IMPORTED_MODULE_12__.getProducts)(page, show, search));
    },
    "delete": function _delete(id) {
      return dispatch((0,_store_actions_backend_products__WEBPACK_IMPORTED_MODULE_12__.deleteProducts)(id));
    },
    reset: function reset() {
      return dispatch((0,_store_actions_backend_products__WEBPACK_IMPORTED_MODULE_12__.resetProducts)());
    }
  };
};
...
/***/ "./resources/js/src/store/actions/backend/products.js":
/*!************************************************************!*\
  !*** ./resources/js/src/store/actions/backend/products.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "resetProducts": () => (/* binding */ resetProducts),
...
/* harmony export */   "patchProducts": () => (/* binding */ patchProducts),
...
var resource = function resource(type) {
  ...
  return _shared_utility__WEBPACK_IMPORTED_MODULE_1__.manageResource.apply(void 0, ['products', {
    start: function start() {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.PRODUCTS_START
      };
    },
    success: function success(data) {
      return _objectSpread({
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.PRODUCTS_SUCCESS
      }, data);
    },
    fail: function fail(error) {
      return {
        type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.PRODUCTS_FAIL,
        error: error
      };
    }
  }, type].concat(params));
...
var resetProducts = function resetProducts() {
  return {
    type: _actionTypes__WEBPACK_IMPORTED_MODULE_0__.PRODUCTS_RESET
  };
};
...
var getProductsInfo = function getProductsInfo() {
  return resource('info');
};
var getProduct = function getProduct(id) {
  return resource('show', id);
};
var postProducts = function postProducts(data) {
  return resource('post', data);
};
var patchProducts = function patchProducts(id, data) {
