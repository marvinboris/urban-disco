    ...
    render() {
        ...
        return (
            <Col xs={xs} sm={sm} md={md} lg={lg} xl={xl} className={outerClassName}>
                ...
                <div className={`rounded-4 d-flex align-items-center mb-4 mb-sm-5 py-3 py-sm-4 px-4 px-sm-5 bg-${dark ? "border" : "border-10"}`}>
                ...
                <div className="row justify-content-center">
                    <div className={`${!addon && "col-lg-9"} ${containerClassName}`}>
                        <div className={`d-flex flex-column h-100 ${dark ? "bg-border text-light " : " "}${className}`} style={style}>
