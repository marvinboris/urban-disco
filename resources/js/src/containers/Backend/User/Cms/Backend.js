...
const Languages = ({ backend, language }) => {
    ...
    const options = Object.keys(backend).sort((a, b) => a.localeCompare(b)).map(key => {
    ...
    return <Row key={'Languages-' + language.abbr}>
        ...
        <div className="col-12">
            ...
            <Row className={`pt-4 ${(activeTab === (language.abbr + '-sidebar')) ? "" : "d-none"}`}>
                {sidebar}
            </Row>

            <Row className={`pt-4 ${(activeTab === (language.abbr + '-dashboard')) ? "" : "d-none"}`}>
                {dashboard}
            </Row>

            <Row className={`pt-4 ${(activeTab === (language.abbr + '-cms')) ? "" : "d-none"}`}>
                {cms}
            </Row>
        ...
        return (
            <>
                ...
                <div className="p-4 pb-0">
                    ...
                    {errors}
                    <Row>
                        <Form onSubmit={this.submitHandler} icon={icon} title={backend} link="/admin/cms" innerClassName="row justify-content-center">
                            {content}
                        </Form>
                    </Row>
                </div>
