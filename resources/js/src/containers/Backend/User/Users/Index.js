...
class Index extends Component {
    ...
    render() {
        ...
        const content = (
            <>
                <Row>
                    <List array={data} loading={loading} data={JSON.stringify(users)} get={this.props.get} total={total} bordered add={add} link="/user/users/add" icon={icon} title={index} className="shadow-sm"
                        fields={[
